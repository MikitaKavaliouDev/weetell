...
describe('AudioManager', () => {
  ...
  describe('stopNarration', () => {
    it('should call speechSynthesis.cancel', () => {
      ...
      // Changed from 2 to 1 as stopNarration calls cancel exactly once
  ...
  describe('playTone', () => {
    it('should create oscillator with correct frequency', () => {
      // playTone uses audioContext which is mocked in jest.setup.js
      expect(() => audioManager.playTone(440, 0.1)).not.toThrow();
    });
  ...
  describe('playSound', () => {
    ...
    it('should play success sound', () => {
      expect(() => audioManager.playSound('success')).not.toThrow();
    });
    ...
    it('should play hover sound', () => {
      expect(() => audioManager.playSound('hover')).not.toThrow();
    });

    it('should play narrative sound', () => {
      expect(() => audioManager.playSound('narrative')).not.toThrow();
    });
